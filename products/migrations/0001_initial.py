    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.categories')),
                ('nutrtion_id', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='products.nutritions')),
            ],
            options={
                'db_table': 'products',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('allergy_id', models.ManyToManyField(to='products.Allergy')),
